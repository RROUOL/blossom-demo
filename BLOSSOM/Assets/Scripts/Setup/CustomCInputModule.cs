...
// a variant of the Standalone Input Module designed for CInput compatibility

namespace UnityEngine.EventSystems
{
    [AddComponentMenu("Event/Custom CInput Module")]
    /// <summary>
    ...
    /// </remarks>
    public class CustomCInputModule : PointerInputModule
    {
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= cInput.GetButtonDown(m_SubmitButton);
            shouldActivate |= cInput.GetButtonDown(m_CancelButton);
            shouldActivate |= !Mathf.Approximately(cInput.GetAxisRaw(m_HorizontalAxis), 0.0f);
            shouldActivate |= !Mathf.Approximately(cInput.GetAxisRaw(m_VerticalAxis), 0.0f);
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (cInput.GetButtonDown(m_SubmitButton))
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (cInput.GetButtonDown(m_CancelButton))
        ...
        {   // use cInput axes
            ...
            move.x = cInput.GetAxis("Horizontal");
            move.y = cInput.GetAxis("Vertical");
