...
namespace Naninovel
{
    ...
    public class AudioConfiguration : Configuration
    {
        ...
        public string MasterGroupPath = "Master/Master";
        [Tooltip("Path of the mixer's group to control master volume.")]
        public string MasterVolumeHandleName = "MSTvolume";
        ...
        public string BgmVolumeHandleName = "BGMvolume";
        ...
        public string SfxVolumeHandleName = "SFXvolume";
        ...
        public string VoiceVolumeHandleName = "DIAvolume";
