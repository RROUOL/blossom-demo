...
/*
        private void AssignKeyCodes(int index, KeyCode keycode1, KeyCode keycode2)
        {
            keycode1 = (KeyCode) System.Enum.Parse(typeof(KeyCode), cInput.GetText(index, 1));
            keycode2 = (KeyCode) System.Enum.Parse(typeof(KeyCode), cInput.GetText(index, 2));
        }

        public void UpdateKeyCodes()
        { // called by InitCInput on initialisation and OnKeyChange()
            AssignKeyCodes(0, Bindings[0].Keys[0], Bindings[0].Keys[1]); // Submit 

            // Rollback impossible.
            // CameraLookX impossible.
            // CameraLookY impossible.
        }
        */
    }
}
